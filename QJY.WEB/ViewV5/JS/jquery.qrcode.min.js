        ...
        return "string" == typeof b && (b = { text: b }),
            ...
            c = function () {
                ...
                for (a.addData(utf16to8(b.text)),
                    ...
                    c.width = b.width,
                    c.height = b.height + b.len,
                    d = c.getContext("2d"),
                    b.src && (e = new Image(), e.src = b.src, e.onload = function () {
                        d.fillStyle = '#fff',
                            d.fillRect(0, b.height, b.width, (b.height + b.len)),
                            d.drawImage(e, (b.width - b.imgWidth) / 2, (b.height - b.imgHeight) / 2, b.imgWidth, b.imgHeight),
                            d.strokeStyle = "#fff",
                            d.stroke(),
                            d.moveTo(b.width / 2, b.height),
                            d.lineTo(b.width / 2, b.height),
                            d.textAlign = "center",
                            d.fillStyle = '#000',
                            d.font = b.len / 1.8 + "px 微软雅黑",
                            d.fillText(b.content, b.width / 2, (b.height + b.len / 1.4))
            ...
            d = function () {
                ...
                for (c.addData(utf16to8(b.text)), c.make(),
                    d = a("<table></table>").css("width", b.width + "px").css("height", b.height + "px").css("border", "0px").css("border-collapse", "collapse").css("background-color", b.background), e = b.width / c.getModuleCount(), f = b.height / c.getModuleCount(), g = 0; g < c.getModuleCount(); g++) {
